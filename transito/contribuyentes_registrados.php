        ...
        <div class = "opciones">
            ...
            <form action="<?php $_SERVER['PHP_SELF']?>" method="post">
                ...
                <?php
                    if(isset($_POST['registrar'])){
                        ...
                        $sql_query = "INSERT INTO contribuyentes VALUES('".$rut_ingreso."','".$nombres_ingreso."','".$app_ingreso."','".$apm_ingreso."','".$contacto_ingreso."','".$email_ingreso."') " ;
                        $resultado_sql = mysqli_query($conn,$sql_query);
            ...
            <div class="tabla_contribuyentes">
                ...
                <table>
                    <thead>
                        <tr>
                            <th>Rut</th> <th>Nombres</th> <th>Apellido Paterno</th> <th>Apellido Materno</th> <th>Contacto</th> <th>Correo Electrónico</th> <th>Editar</th>
                        </tr>
                    </thead>
